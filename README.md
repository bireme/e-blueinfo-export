...
## How to use
Activate the plugin and access `http://<domain>/?feed=report` to show the output file.

You can also use the following parameters and filters:

* `country`- Filter by country (2-digit ISO code)
...
## NOTES
* The __country__ parameter is MANDATORY
* For this plugin to work correctly, it is MANDATORY to install and activate the [e-BlueInfo plugin](https://github.com/bireme/e-blueinfo-wp-plugin)
...
<data>
    ...
    <documents>
        <document>
            <title><![CDATA[TITLE 1]]></name>
            <field name="community"><![CDATA[COMMUNITY 1]]></field>
            ...
            <field name="collection"><![CDATA[COLLECTION 1]]></field>
            ...
            <field name="downloads">10</field>
        </document>
        <document>
            <title><![CDATA[TITLE 2]]></name>
            <field name="community"><![CDATA[COMMUNITY 2]]></field>
            ...
            <field name="collection"><![CDATA[COLLECTION 2]]></field>
            ...
            <field name="downloads">10</field>
        </document>
    </documents>
